...
def is_desired_file(file_path):
    """Check if the file is a Python, HTML, JavaScript, TypeScript, Svelte, or Rust file."""
    return file_path.endswith(".py") or file_path.endswith(".html") or file_path.endswith(".htm") or file_path.endswith(".js") or file_path.endswith(".ts") or file_path.endswith(".svelte") or file_path.endswith(".rs")
...
if __name__ == "__main__":
    ...
    output_file = f"{args.repo_url.split('/')[-1]}_code.txt"
